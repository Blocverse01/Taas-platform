...
import { getProjectAssetPageProp } from '@/data/adapters/server/taas-api/project/page-utils';
...
const ProjectAssetPage: NextPageWithLayout<
  InferGetServerSidePropsType<typeof getServerSideProps>
> = ({ asset }) => {
  return (
    <AssetPage
      projectId={asset.project.id}
      projectSafeWallet={asset.project.multiSigController}
      projectTokenFactory={asset.project.tokenFactory}
