...
const ProjectDashboardPage: NextPageWithLayout<InferGetServerSidePropsType<typeof getServerSideProps>> = ({
  project,
}) => {
...
ProjectDashboardPage.getLayout = (page) => (
  <ProjectLayout breadcrumbs={[page.props.project.name, "dashboard"]} projectId={page.props.project.id}>
    {page}
  </ProjectLayout>
);
